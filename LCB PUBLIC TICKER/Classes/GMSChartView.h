 ...
 */
@property (nonatomic, assign) GMSChartViewState state;
 ...
 * Used as a vertical selection view in GMSChartView subclasses.
 */
@interface GMSChartVerticalSelectionView : UIView

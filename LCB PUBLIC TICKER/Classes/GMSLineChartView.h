 ...
 */
typedef NS_ENUM(NSInteger, GMSLineChartViewLineStyle){
    /**
     *  Solid line.
     */
    GMSLineChartViewLineStyleSolid,
    /**
     *  Dashed line with a phase of 3:2 (3 points dashed, 2 points spaced).
     */
	GMSLineChartViewLineStyleDashed
};

@protocol GMSLineChartViewDelegate;
@protocol GMSLineChartViewDataSource;

@interface GMSLineChartView : GMSChartView

@property (nonatomic, weak) id<GMSLineChartViewDelegate> delegate;
@property (nonatomic, weak) id<GMSLineChartViewDataSource> dataSource;
...
@protocol GMSLineChartViewDelegate <NSObject>
...
- (void)lineChartView:(GMSLineChartView *)lineChartView didSelectLineAtIndex:(NSUInteger)lineIndex horizontalIndex:(NSUInteger)horizontalIndex;
...
@protocol GMSLineChartViewDataSource <NSObject>
 ...
 */
- (CGFloat)verticalSelectionWidthForLineChartView:(GMSLineChartView *)lineChartView;
 ...
 *  See GMSLineChartViewLineStyle for line style descriptions.
 *
 *  Default: GMSLineChartViewLineStyleSolid
 *
 *  @param lineChartView    The line chart object requesting this information.
 *  @param lineIndex        An index number identifying a line in the chart.
 *
